...

{
  "scriptVariations": [
    {
      "hook": "Attention-grabbing hook for variation 1",
      "mainContent": "Main content points for variation 1",
      "callToAction": "Call-to-action for variation 1",
      "visualCues": ["Visual cue 1", "Visual cue 2", "Visual cue 3"],
      "audioNotes": ["Audio note 1", "Audio note 2"]
    },
    {
      "hook": "Attention-grabbing hook for variation 2",
      "mainContent": "Main content points for variation 2",
      "callToAction": "Call-to-action for variation 2",
      "visualCues": ["Visual cue 1", "Visual cue 2", "Visual cue 3"],
      "audioNotes": ["Audio note 1", "Audio note 2"]
    }
  ],
  "platformSpecific": {
    "instagramReels": {
      "script": "Instagram Reels specific script",
      "hashtags": ["#hashtag1", "#hashtag2", "#hashtag3"],
      "trendingSounds": ["Trending sound 1", "Trending sound 2"],
      "engagementTips": ["Tip 1", "Tip 2", "Tip 3"]
    },
    "tiktok": {
      "script": "TikTok specific script",
      "hashtags": ["#hashtag1", "#hashtag2", "#hashtag3"],
      "trendingSounds": ["Trending sound 1", "Trending sound 2"],
      "engagementTips": ["Tip 1", "Tip 2", "Tip 3"]
    },
    "youtubeShorts": {
      "script": "YouTube Shorts specific script",
      "hashtags": ["#hashtag1", "#hashtag2", "#hashtag3"],
      "engagementTips": ["Tip 1", "Tip 2", "Tip 3"]
    }
  },
  ...
  "audioGuidance": {
    "backgroundMusic": "Background music recommendations",
    "voiceoverStyle": "Voiceover style and tone",
    "soundEffects": ["Sound effect 1", "Sound effect 2"]
  },
  "optimization": {
    "titleSuggestions": ["Title 1", "Title 2", "Title 3"],
    "descriptionTemplates": ["Description template 1", "Description template 2"],
...
Create engaging, platform-optimized short-form video scripts that capture attention and drive engagement. Include platform-specific best practices and optimization tips. Return ONLY valid JSON, no explanation.`;
  ...
  const response = await axios.post(
    'https://api.openai.com/v1/chat/completions',
    {
      model: 'gpt-4',
      messages: [
        { role: 'system', content: 'You are an expert short-form video content creator that generates engaging scripts in JSON format.' },
        { role: 'user', content: prompt }
      ],
      max_tokens: 3000,
      temperature: 0.7
